        ...
        <ul class="nav-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu fsz-sm">
                    <li><a href="admin/user/edit/{{ Auth::user()->id }}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-settings mR-10"></i> <span>Setting</span></a></li>
                    <li><a href="admin/user/edit/{{ Auth::user()->id }}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-user mR-10"></i> <span>Profile</span></a></li>
